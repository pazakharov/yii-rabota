            ...
            <div class="container">
                <nav class="navbar navigation">
                    ...
                    <ul class="navigation-nav">
                        ...
                        ?><li class="nav-item">
                                <a class="nav-link" href="<?= Url::toRoute('resume/my-resume') ?>">Мои резюме</a>
                            </li> <?php
                                    echo '<li class="nav-item">';
                                    echo Html::beginForm(['/site/logout'], 'post');
                                    echo Html::submitButton('Logout (' . Yii::$app->user->identity->username . ')', ['class' => 'btn btn-link logout']) . Html::endForm() . '</li>';
                                }
