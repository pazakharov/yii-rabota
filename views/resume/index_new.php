        ...
        <div class="row">
            ...
            <div class="col-lg-9 desctop-992-pr-16">
                ...
                <ul class="dor-pagination mb128">
                    <li class="page-link-prev"><a href="#"><img class="mr8" src="images/mini-left-arrow.svg"
                                alt="arrow"> Назад</a>
                    </li>
                    <li><a href="#">1</a></li>
                    ...
                    <li><a class="grey" href="#">...</a></li>
                    <li><a href="#">10</a></li>
                    <li class="page-link-next"><a href="#">Далее <img class="ml8" src="images/mini-right-arrow.svg"
                                alt="arrow"></a>
                    </li>
                </ul>
                <?php Pjax::end(); ?>
            ...
            <div
                ...
                <form id="searchform" action="<?=Url::current()?>">
                    ...
                    </div><?php Pjax::begin(['id' => 'links']); ?>
                    <div class="signin-modal__switch-btns-wrap resume-list__switch-btns-wrap mb16">
                        <a href="<?=Url::current(['sex' => null])?>"
                            class="signin-modal__switch-btn <?=!isset($params['sex'])?'active':'' ?>">Все</a>
                        <a href="<?=Url::current(['sex' => '1'])?>"
                            class="signin-modal__switch-btn <?=isset($params['sex']) && $params['sex'] == '1' ?'active':'' ?>">Мужчины</a>
                        <a href="<?=Url::current(['sex' => '2'])?>"
                            class="signin-modal__switch-btn <?=isset($params['sex']) && $params['sex'] == '2' ?'active':'' ?>">Женщины</a>
                    </div>
                    <?php Pjax::end(); ?>
                    ...
                    <div class="vakancy-page-filter-block__row mb24">
                        ...
                        <div class="d-flex">
                            <?= Html::input('text', 'zp1',isset($params['zp1'])?$params['zp1']:'' , ['class' => 'dor-input w100 ','placeholder' => 'От','id'=>'zp1']) ?><img
                                class="rub-icon" src="images/rub-icon.svg" alt="rub-icon">
                            <?= Html::input('text', 'zp2',isset($params['zp2'])?$params['zp2']:'' , ['class' => 'dor-input  w100','placeholder' => 'До','id'=>'zp2']) ?><img
                                class="rub-icon" src="images/rub-icon.svg" alt="rub-icon">
                        </div>
                    </div>
                    <div class="vakancy-page-filter-block__row mb24">
                    ...
                    <div class="vakancy-page-filter-block__row mb24">
                        ...
                        <div class="d-flex">
                            <?= Html::input('text', 'birthdate1',isset($params['birthdate1'])?$params['birthdate1']:'' , ['class' => 'dor-input w100 ','placeholder' => 'От','id'=>'birthdate1']) ?><img
                                class="rub-icon" src="images/rub-icon.svg" alt="rub-icon">
                            <?= Html::input('text', 'birthdate2',isset($params['birthdate2'])?$params['birthdate2']:'' , ['class' => 'dor-input  w100','placeholder' => 'До','id'=>'birthdate2']) ?><img
                                class="rub-icon" src="images/rub-icon.svg" alt="rub-icon">
                        </div>
                    </div>
                    <div class="vakancy-page-filter-block__row mb24">
                        ...
                        <div class="profile-info">
                            ...
                            <?=Html::checkboxList('opyt_dev',isset($params['opyt_dev'])?$params['opyt_dev']:'',['1'=>'Без опыта',
